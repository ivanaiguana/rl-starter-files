...
# Ensure the script recognizes the correct directory paths for imports
sys.path.append(os.path.dirname(os.path.dirname(os.path.abspath(__file__))))
...
#call --algo ppo --text --recurrence 2
...
if __name__ == "__main__":
    ...
    for env_name in env_names:
        ...
        model_name = args.model or f"{env_name}_{args.algo}_seed{args.seed}_{date}"
        ...
        for i in range(args.procs):
            envs.append(utils.make_env(env_name, args.seed + 10000 * i))
